  ...
  return (
    <div className="flex flex-col gap-3 p-4 bg-white/80 dark:bg-zinc-900/60 border border-zinc-200 dark:border-zinc-800/80 rounded-xl backdrop-blur-sm shadow-md transition-colors duration-300">
      <div className="flex items-center justify-between border-b border-zinc-200 dark:border-zinc-800/60 pb-3">
        ...
        <span className="text-[10px] font-mono bg-violet-100 dark:bg-violet-950 text-violet-700 dark:text-violet-300 border border-violet-200 dark:border-violet-850/80 px-2.5 py-0.5 rounded-full font-bold uppercase tracking-wider">
      ...
      <div className="grid grid-cols-2 gap-4">
        {/* Time Complexity */}
        <div className="bg-zinc-100/40 dark:bg-zinc-950/40 border border-zinc-200 dark:border-zinc-800 p-3 rounded-lg flex flex-col gap-1">
      ...
      <div className="flex flex-wrap gap-1.5 mt-1">
        {selectedAlgo.tags.map((tag) => (
          <span
            key={tag}
            className="text-[9px] font-mono bg-zinc-100 dark:bg-zinc-800/60 border border-zinc-200 dark:border-zinc-700/60 text-zinc-500 dark:text-zinc-400 px-2 py-0.5 rounded font-semibold"
          >
            #{tag}
          </span>
        ))}
