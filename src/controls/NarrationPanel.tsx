...
export const NarrationPanel: React.FC = () => {
  ...
  return (
    <div className="w-full bg-zinc-900/60 border border-zinc-800/80 rounded-xl p-4 shadow-inner backdrop-blur-sm">
      ...
      <div
        id="algo-narration"
        aria-live="polite"
        className="text-sm text-zinc-200 font-medium leading-relaxed font-sans min-h-[40px]"
      >
        {description}
      </div>
    </div>
